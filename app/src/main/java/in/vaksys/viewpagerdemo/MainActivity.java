...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] CompanyImgs = {R.drawable.wallpaper, R.drawable.wallpaper, R.drawable.wallpaper, R.drawable.wallpaper, R.drawable.wallpaper, R.drawable.wallpaper
    ...
    protected void initViewPager() {
        ...
        mRecyclerViewPager.setAdapter(new LayoutAdapter(this, mRecyclerViewPager, CompanyImgs));
